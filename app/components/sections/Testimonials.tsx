      ...
      <div className='container mx-auto px-6 reveal-on-scroll'>
        ...
        <div className='max-w-4xl'>
          <p className='text-xl md:text-3xl font-light leading-relaxed mb-12 text-gray-700 dark:text-gray-200'>
            ...
            curriculum at Tutedude, which embarks his skills and deep knowledge
            in the UX domain. His decisive approach and ability to commit
            towards task completion was commendable.
          </p>
